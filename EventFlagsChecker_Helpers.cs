namespace MissingEventFlagsCheckerPlugin
{
    ...
    static class EventFlagTypeExtensions
    {
        public static EventFlagsChecker.EventFlagType Parse(this EventFlagsChecker.EventFlagType _, string txt) => txt switch
        {
            ...
            "FLY DESTINATION" => EventFlagsChecker.EventFlagType.FlyDestination,
            "FLY SPOT" => EventFlagsChecker.EventFlagType.FlyDestination, // TODO: remove later
            "BERRY TREE" => EventFlagsChecker.EventFlagType.BerryTree,
            "COLLECTIBLE" => EventFlagsChecker.EventFlagType.Collectible,
            "COLLECTABLE" => EventFlagsChecker.EventFlagType.Collectible, // TODO: remove later
            "CHALLENGE" => EventFlagsChecker.EventFlagType.Challenge,
            "ONLINE EVENT" => EventFlagsChecker.EventFlagType.OnlineEvent,
        ...
        public static string AsText(this EventFlagsChecker.EventFlagType flagType) => flagType switch
        {
            ...
            EventFlagsChecker.EventFlagType.FlyDestination => "FLY DESTINATION",
            EventFlagsChecker.EventFlagType.BerryTree => "BERRY TREE",
            EventFlagsChecker.EventFlagType.Collectible => "COLLECTIBLE",
            EventFlagsChecker.EventFlagType.Challenge => "CHALLENGE",
            EventFlagsChecker.EventFlagType.OnlineEvent => "ONLINE EVENT",
