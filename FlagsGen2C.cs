...
namespace MissingEventFlagsCheckerPlugin
{
    internal class FlagsGen2C : FlagsOrganizer
    {
            ...
            switch (flagType)
            {
                ...
                case FlagType.HiddenItem:
                    ...
                    for (int i = 0x07D; i <= 0x0B8; ++i)
                        flagHelper.SetEventFlag(i, value);
                    // Kanto hidden items
                    for (int i = 0x0E4; i <= 0x0FF; ++i)
                        flagHelper.SetEventFlag(i, value);
                    break;

                case FlagType.TrainerBattle:
                    // Trainers
                    for (int i = 0x3E8; i <= 0x5CB; ++i)
                        flagHelper.SetEventFlag(i, value);
                    break;
            }
        }
        ...
        protected override void CheckAllMissingFlags()
        {
            ...
            CheckMissingFlag(0x0FF, FlagType.HiddenItem, "", "BURNED_TOWER_1F_HIDDEN_ULTRA_BALL");
            ...
            CheckMissingFlag(0x645, FlagType.FieldItem, "", "LAKE_OF_RAGE_ELIXER");
            ...
            CheckMissingFlag(0x648, FlagType.FieldItem, "", "SPROUT_TOWER_2F_X_ACCURACY");
            ...
            CheckMissingFlag(0x64D, FlagType.FieldItem, "", "TIN_TOWER_4F_PP_UP");
            ...
            CheckMissingFlag(0x654, FlagType.FieldItem, "", "TEAM_ROCKET_BASE_B3F_ULTRA_BALL");
            CheckMissingFlag(0x655, FlagType.FieldItem, "", "GOLDENROD_UNDERGROUND_WAREHOUSE_ULTRA_BALL");
            CheckMissingFlag(0x656, FlagType.FieldItem, "", "BURNED_TOWER_1F_HP_UP");
            ...
            CheckMissingFlag(0x65B, FlagType.FieldItem, "", "UNION_CAVE_1F_X_ATTACK");
            CheckMissingFlag(0x65C, FlagType.FieldItem, "", "UNION_CAVE_1F_POTION");
            ...
            CheckMissingFlag(0x666, FlagType.FieldItem, "", "OLIVINE_LIGHTHOUSE_5F_SUPER_REPEL");
            ...
            CheckMissingFlag(0x66B, FlagType.FieldItem, "", "TEAM_ROCKET_BASE_B1F_GUARD_SPEC");
            CheckMissingFlag(0x66C, FlagType.FieldItem, "", "TEAM_ROCKET_BASE_B2F_TM_THIEF");
            CheckMissingFlag(0x66D, FlagType.FieldItem, "", "TEAM_ROCKET_BASE_B3F_PROTEIN");
            CheckMissingFlag(0x66E, FlagType.FieldItem, "", "TEAM_ROCKET_BASE_B3F_X_SPECIAL");
            CheckMissingFlag(0x66F, FlagType.FieldItem, "", "TEAM_ROCKET_BASE_B3F_FULL_HEAL");
            ...
            CheckMissingFlag(0x687, FlagType.FieldItem, "", "MOUNT_MORTAR_B1F_CARBOS");
            ...
            CheckMissingFlag(0x690, FlagType.FieldItem, "", "WHIRL_ISLAND_SW_ULTRA_BALL");
            ...
            CheckMissingFlag(0x69A, FlagType.FieldItem, "", "SILVER_CAVE_ROOM_1_PROTEIN");
            ...
            CheckMissingFlag(0x6A7, FlagType.FieldItem, "", "VICTORY_ROAD_HP_UP");
            ...
            CheckMissingFlag(0x6AE, FlagType.FieldItem, "", "ROUTE_31_POTION");
            ...
            CheckMissingFlag(0x6B1, FlagType.FieldItem, "", "ROUTE_32_REPEL");
            ...
            CheckMissingFlag(0x6B8, FlagType.FieldItem, "", "ROUTE_45_NUGGET");
            ...
            CheckMissingFlag(0x6BC, FlagType.FieldItem, "", "ROUTE_46_X_SPEED");
            ...
            CheckMissingFlag(0x794, FlagType.FieldItem, "", "PICKED_UP_GOLD_BERRY_FROM_HO_OH_ITEM_ROOM");
            CheckMissingFlag(0x795, FlagType.FieldItem, "", "PICKED_UP_MYSTERYBERRY_FROM_HO_OH_ITEM_ROOM");
            CheckMissingFlag(0x796, FlagType.FieldItem, "", "PICKED_UP_REVIVAL_HERB_FROM_HO_OH_ITEM_ROOM");
            CheckMissingFlag(0x797, FlagType.FieldItem, "", "PICKED_UP_CHARCOAL_FROM_HO_OH_ITEM_ROOM");
            CheckMissingFlag(0x798, FlagType.FieldItem, "", "PICKED_UP_BERRY_FROM_KABUTO_ITEM_ROOM");
            CheckMissingFlag(0x799, FlagType.FieldItem, "", "PICKED_UP_PSNCUREBERRY_FROM_KABUTO_ITEM_ROOM");
            CheckMissingFlag(0x79A, FlagType.FieldItem, "", "PICKED_UP_HEAL_POWDER_FROM_KABUTO_ITEM_ROOM");
            CheckMissingFlag(0x79B, FlagType.FieldItem, "", "PICKED_UP_ENERGYPOWDER_FROM_KABUTO_ITEM_ROOM");
            CheckMissingFlag(0x79C, FlagType.FieldItem, "", "PICKED_UP_MYSTERYBERRY_FROM_OMANYTE_ITEM_ROOM");
            CheckMissingFlag(0x79D, FlagType.FieldItem, "", "PICKED_UP_MYSTIC_WATER_FROM_OMANYTE_ITEM_ROOM");
            CheckMissingFlag(0x79E, FlagType.FieldItem, "", "PICKED_UP_STARDUST_FROM_OMANYTE_ITEM_ROOM");
            CheckMissingFlag(0x79F, FlagType.FieldItem, "", "PICKED_UP_STAR_PIECE_FROM_OMANYTE_ITEM_ROOM");
            CheckMissingFlag(0x7A0, FlagType.FieldItem, "", "PICKED_UP_GOLD_BERRY_FROM_AERODACTYL_ITEM_ROOM");
            CheckMissingFlag(0x7A1, FlagType.FieldItem, "", "PICKED_UP_MOON_STONE_FROM_AERODACTYL_ITEM_ROOM");
            CheckMissingFlag(0x7A2, FlagType.FieldItem, "", "PICKED_UP_HEAL_POWDER_FROM_AERODACTYL_ITEM_ROOM");
            CheckMissingFlag(0x7A3, FlagType.FieldItem, "", "PICKED_UP_ENERGY_ROOT_FROM_AERODACTYL_ITEM_ROOM");

            CheckMissingFlag(0x7A6, FlagType.FieldItem, "", "MOUNT_MORTAR_1F_INSIDE_MAX_POTION");
            CheckMissingFlag(0x7A7, FlagType.FieldItem, "", "MOUNT_MORTAR_1F_INSIDE_NUGGET");

            CheckMissingFlag(0x7B8, FlagType.FieldItem, "", "ROUTE_30_ANTIDOTE");
            CheckMissingFlag(0x7B9, FlagType.FieldItem, "", "ILEX_FOREST_X_ATTACK");
            CheckMissingFlag(0x7BA, FlagType.FieldItem, "", "ILEX_FOREST_ANTIDOTE");
            CheckMissingFlag(0x7BB, FlagType.FieldItem, "", "ILEX_FOREST_ETHER");
            CheckMissingFlag(0x7BC, FlagType.FieldItem, "", "ROUTE_34_NUGGET");
            CheckMissingFlag(0x7BD, FlagType.FieldItem, "", "ROUTE_44_MAX_REPEL");
            CheckMissingFlag(0x7BE, FlagType.FieldItem, "", "ICE_PATH_1F_PROTEIN");
            CheckMissingFlag(0x7BF, FlagType.FieldItem, "", "DRAGONS_DEN_B1F_CALCIUM");
            CheckMissingFlag(0x7C0, FlagType.FieldItem, "", "DRAGONS_DEN_B1F_MAX_ELIXER");
            CheckMissingFlag(0x7C1, FlagType.FieldItem, "", "SILVER_CAVE_ROOM_1_ULTRA_BALL");
            CheckMissingFlag(0x7C2, FlagType.FieldItem, "", "SILVER_CAVE_ROOM_2_CALCIUM");
            CheckMissingFlag(0x7C3, FlagType.FieldItem, "", "SILVER_CAVE_ROOM_2_ULTRA_BALL");
            CheckMissingFlag(0x7C4, FlagType.FieldItem, "", "SILVER_CAVE_ROOM_2_PP_UP");
            CheckMissingFlag(0x7C6, FlagType.FieldItem, "", "TIN_TOWER_6F_MAX_POTION");
            CheckMissingFlag(0x7C7, FlagType.FieldItem, "", "TIN_TOWER_9F_HP_UP");
            CheckMissingFlag(0x7C8, FlagType.FieldItem, "", "MOUNT_MORTAR_1F_INSIDE_IRON");
            CheckMissingFlag(0x7C9, FlagType.FieldItem, "", "MOUNT_MORTAR_1F_INSIDE_ULTRA_BALL");
            CheckMissingFlag(0x7CA, FlagType.FieldItem, "", "MOUNT_MORTAR_B1F_FULL_RESTORE");
            CheckMissingFlag(0x7CB, FlagType.FieldItem, "", "MOUNT_MORTAR_B1F_MAX_ETHER");
            CheckMissingFlag(0x7CC, FlagType.FieldItem, "", "MOUNT_MORTAR_B1F_PP_UP");
            CheckMissingFlag(0x7CD, FlagType.FieldItem, "", "RADIO_TOWER_5F_ULTRA_BALL");
            CheckMissingFlag(0x7CE, FlagType.FieldItem, "", "DARK_CAVE_VIOLET_ENTRANCE_DIRE_HIT");
            ...
            CheckMissingFlag(0x03A, FlagType.GeneralEvent, "", "LAKE_OF_RAGE_ELIXIR_ON_STANDBY");
            ...
            CheckMissingFlag(0x078, FlagType.GeneralEvent, "", "GOT_CLEAR_BELL");
            ...
            CheckMissingFlag(0x0BD, FlagType.GeneralEvent, "", "GOT_DRATINI");
            ...
            CheckMissingFlag(0x100, FlagType.GeneralEvent, "", "GINA_GAVE_LEAF_STONE");
            CheckMissingFlag(0x101, FlagType.GeneralEvent, "", "ALAN_GAVE_FIRE_STONE");
            CheckMissingFlag(0x102, FlagType.GeneralEvent, "", "DANA_GAVE_THUNDERSTONE");
            CheckMissingFlag(0x103, FlagType.GeneralEvent, "", "TULLY_GAVE_WATER_STONE");
            CheckMissingFlag(0x104, FlagType.GeneralEvent, "", "TIFFANY_GAVE_PINK_BOW");
            ...
            //CheckMissingFlag(0x26A, FlagType.GeneralEvent, "", "KENJI_ON_BREAK");
            ...
            CheckMissingFlag(0x326, FlagType.GeneralEvent, "", "WALL_OPENED_IN_HO_OH_CHAMBER");
            CheckMissingFlag(0x327, FlagType.GeneralEvent, "", "WALL_OPENED_IN_KABUTO_CHAMBER");
            CheckMissingFlag(0x328, FlagType.GeneralEvent, "", "WALL_OPENED_IN_OMANYTE_CHAMBER");
            CheckMissingFlag(0x329, FlagType.GeneralEvent, "", "WALL_OPENED_IN_AERODACTYL_CHAMBER");
            CheckMissingFlag(0x32B, FlagType.GeneralEvent, "", "WADE_HAS_BERRY");
            CheckMissingFlag(0x32C, FlagType.GeneralEvent, "", "WADE_HAS_PSNCUREBERRY");
            CheckMissingFlag(0x32D, FlagType.GeneralEvent, "", "WADE_HAS_PRZCUREBERRY");
            CheckMissingFlag(0x32E, FlagType.GeneralEvent, "", "WADE_HAS_BITTER_BERRY");
            CheckMissingFlag(0x32F, FlagType.GeneralEvent, "", "WILTON_HAS_ULTRA_BALL");
            CheckMissingFlag(0x330, FlagType.GeneralEvent, "", "WILTON_HAS_GREAT_BALL");
            CheckMissingFlag(0x331, FlagType.GeneralEvent, "", "WILTON_HAS_POKE_BALL");
            CheckMissingFlag(0x333, FlagType.GeneralEvent, "", "FOUGHT_EUSINE");
            CheckMissingFlag(0x335, FlagType.GeneralEvent, "", "FOUGHT_SUICUNE");
            CheckMissingFlag(0x336, FlagType.GeneralEvent, "", "GOT_RAINBOW_WING");
            CheckMissingFlag(0x337, FlagType.GeneralEvent, "", "HUEY_PROTEIN");
            CheckMissingFlag(0x338, FlagType.GeneralEvent, "", "JOEY_HP_UP");
            CheckMissingFlag(0x339, FlagType.GeneralEvent, "", "VANCE_CARBOS");
            CheckMissingFlag(0x33A, FlagType.GeneralEvent, "", "PARRY_IRON");
            CheckMissingFlag(0x33B, FlagType.GeneralEvent, "", "ERIN_CALCIUM");
            CheckMissingFlag(0x33C, FlagType.GeneralEvent, "", "BUENA_OFFERED_HER_PHONE_NUMBER");
            //CheckMissingFlag(0x33D, FlagType.GeneralEvent, "", "MET_BUENA");
            CheckMissingFlag(0x33E, FlagType.GeneralEvent, "", "GOT_ODD_EGG");
            CheckMissingFlag(0x340, FlagType.GeneralEvent, "", "GOT_GS_BALL_FROM_POKECOM_CENTER");
            ...
            CheckMissingFlag(0x454, FlagType.TrainerBattle, "", "FISHER_TULLY");
            ...
            CheckMissingFlag(0x45F, FlagType.TrainerBattle, "", "FISHER_TULLY2");
            CheckMissingFlag(0x460, FlagType.TrainerBattle, "", "FISHER_TULLY3");
            ...
            CheckMissingFlag(0x5BD, FlagType.TrainerBattle, "", "COOLTRAINERM_DARIN");
            CheckMissingFlag(0x5BE, FlagType.TrainerBattle, "", "COOLTRAINERF_CARA");
            CheckMissingFlag(0x5BF, FlagType.TrainerBattle, "", "TWINS_LEA_AND_PIA");
            CheckMissingFlag(0x5C0, FlagType.TrainerBattle, "", "BUG_CATCHER_WAYNE");
            CheckMissingFlag(0x5C1, FlagType.TrainerBattle, "", "BEAUTY_OLIVIA");
            CheckMissingFlag(0x5C2, FlagType.TrainerBattle, "", "POKEFANF_JAIME");
            CheckMissingFlag(0x5C3, FlagType.TrainerBattle, "", "CAMPER_QUENTIN");
            CheckMissingFlag(0x5C4, FlagType.TrainerBattle, "", "POKEMANIAC_MILLER");
            CheckMissingFlag(0x5C5, FlagType.TrainerBattle, "", "SUPER_NERD_HUGH");
            CheckMissingFlag(0x5C6, FlagType.TrainerBattle, "", "SUPER_NERD_MARKUS");
            CheckMissingFlag(0x5C7, FlagType.TrainerBattle, "", "POKEFANM_REX");
            CheckMissingFlag(0x5C8, FlagType.TrainerBattle, "", "POKEFANM_ALLAN");
            CheckMissingFlag(0x5C9, FlagType.TrainerBattle, "", "SAGE_GAKU");
            CheckMissingFlag(0x5CA, FlagType.TrainerBattle, "", "SAGE_MASA");
            CheckMissingFlag(0x5CB, FlagType.TrainerBattle, "", "SAGE_KOJI");
