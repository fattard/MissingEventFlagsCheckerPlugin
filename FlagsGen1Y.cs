...
namespace MissingEventFlagsCheckerPlugin
{
    internal class FlagsGen1Y : FlagsOrganizer
    {
        ...
        protected void AssembleFlagsList()
        {
            ...
            AddFlag(m_eventFlags[0x0A8], FlagType.GeneralEvent, "", "GOT_BULBASAUR_IN_CERULEAN");
            ...
            AddFlag(m_eventFlags[0x147], FlagType.GeneralEvent, "", "GOT_SQUIRTLE_FROM_OFFICER_JENNY");
            ...
            AddFlag(m_eventFlags[0x54F], FlagType.GeneralEvent, "", "GOT_CHARMANDER_FROM_DAMIAN");
            ...
            AddFlag(m_eventFlags[0x565], FlagType.TrainerBattle, "", "BEAT_VIRIDIAN_FOREST_TRAINER_3");
            AddFlag(m_eventFlags[0x566], FlagType.TrainerBattle, "", "BEAT_VIRIDIAN_FOREST_TRAINER_4");
            ...
            if (!m_eventFlags[0x578] && !m_eventFlags[0x57F])
            {
                ...
                AddFlag(m_eventFlags[0x578], FlagType.GeneralEvent, "", "GOT_DOME/HELIX_FOSSIL");
            }
