...
namespace MissingEventFlagsCheckerPlugin
{
    internal class FlagsGen1RB : FlagsOrganizer
    {
        ...
        protected override void CheckAllMissingFlags()
        {
            ...
            // Hidden Items
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x00], FlagType.HiddenItem, "", "VIRIDIAN_FOREST_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x01], FlagType.HiddenItem, "", "VIRIDIAN_FOREST_1");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x02], FlagType.HiddenItem, "", "MT_MOON_B2F_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x03], FlagType.HiddenItem, "", "ROUTE_25_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x04], FlagType.HiddenItem, "", "ROUTE_9_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x05], FlagType.HiddenItem, "", "SS_ANNE_KITCHEN_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x06], FlagType.HiddenItem, "", "SS_ANNE_B1F_ROOMS_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x07], FlagType.HiddenItem, "", "ROUTE_10_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x08], FlagType.HiddenItem, "", "ROUTE_10_1");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x09], FlagType.HiddenItem, "", "ROCKET_HIDEOUT_B1F_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x0A], FlagType.HiddenItem, "", "ROCKET_HIDEOUT_B3F_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x0B], FlagType.HiddenItem, "", "ROCKET_HIDEOUT_B4F_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x0C], FlagType.HiddenItem, "", "POKEMON_TOWER_5F_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x0D], FlagType.HiddenItem, "", "ROUTE_13_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x0E], FlagType.HiddenItem, "", "ROUTE_13_1");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x0F], FlagType.HiddenItem, "", "POKEMON_MANSION_B1F_0");
            //CheckMissingFlag(m_obtainedHiddenItemsFlags[0x10], FlagType.HiddenItem, "", "SAFARI_ZONE_GATE_0"); // inaccessible
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x11], FlagType.HiddenItem, "", "SAFARI_ZONE_WEST_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x12], FlagType.HiddenItem, "", "SILPH_CO_5F_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x13], FlagType.HiddenItem, "", "SILPH_CO_9F_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x14], FlagType.HiddenItem, "", "COPYCATS_HOUSE_2F_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x15], FlagType.HiddenItem, "", "CERULEAN_CAVE_1F_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x16], FlagType.HiddenItem, "", "CERULEAN_CAVE_B1F_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x17], FlagType.HiddenItem, "", "POWER_PLANT_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x18], FlagType.HiddenItem, "", "POWER_PLANT_1");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x19], FlagType.HiddenItem, "", "SEAFOAM_ISLANDS_B2F_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x1A], FlagType.HiddenItem, "", "SEAFOAM_ISLANDS_B4F_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x1B], FlagType.HiddenItem, "", "POKEMON_MANSION_1F_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x1C], FlagType.HiddenItem, "", "POKEMON_MANSION_3F_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x1D], FlagType.HiddenItem, "", "ROUTE_23_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x1E], FlagType.HiddenItem, "", "ROUTE_23_1");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x1F], FlagType.HiddenItem, "", "ROUTE_23_2");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x20], FlagType.HiddenItem, "", "VICTORY_ROAD_2F_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x21], FlagType.HiddenItem, "", "VICTORY_ROAD_2F_1");
            //CheckMissingFlag(m_obtainedHiddenItemsFlags[0x22], FlagType.HiddenItem, "", "UNUSED_MAP_6F_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x23], FlagType.HiddenItem, "", "VIRIDIAN_CITY_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x24], FlagType.HiddenItem, "", "ROUTE_11_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x25], FlagType.HiddenItem, "", "ROUTE_12_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x26], FlagType.HiddenItem, "", "ROUTE_17_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x27], FlagType.HiddenItem, "", "ROUTE_17_1");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x28], FlagType.HiddenItem, "", "ROUTE_17_2");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x29], FlagType.HiddenItem, "", "ROUTE_17_3");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x2A], FlagType.HiddenItem, "", "ROUTE_17_4");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x2B], FlagType.HiddenItem, "", "UNDERGROUND_PATH_NORTH_SOUTH_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x2C], FlagType.HiddenItem, "", "UNDERGROUND_PATH_NORTH_SOUTH_1");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x2D], FlagType.HiddenItem, "", "UNDERGROUND_PATH_WEST_EAST_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x2E], FlagType.HiddenItem, "", "UNDERGROUND_PATH_WEST_EAST_1");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x2F], FlagType.HiddenItem, "", "CELADON_CITY_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x30], FlagType.HiddenItem, "", "ROUTE_25_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x31], FlagType.HiddenItem, "", "MT_MOON_B2F_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x32], FlagType.HiddenItem, "", "SEAFOAM_ISLANDS_B3F_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x33], FlagType.HiddenItem, "", "VERMILION_CITY_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x34], FlagType.HiddenItem, "", "CERULEAN_CITY_0");
            CheckMissingFlag(m_obtainedHiddenItemsFlags[0x35], FlagType.HiddenItem, "", "ROUTE_4_0");

            // Field Items
            CheckMissingFlag(m_missableObjectFlags[0x19], FlagType.FieldItem, "", "ROUTE_2_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0x1A], FlagType.FieldItem, "", "ROUTE_2_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0x1B], FlagType.FieldItem, "", "ROUTE_4_ITEM");
            CheckMissingFlag(m_missableObjectFlags[0x1C], FlagType.FieldItem, "", "ROUTE_9_ITEM");
            CheckMissingFlag(m_missableObjectFlags[0x1E], FlagType.FieldItem, "", "ROUTE_12_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0x1F], FlagType.FieldItem, "", "ROUTE_12_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0x20], FlagType.FieldItem, "", "ROUTE_15_ITEM");
            CheckMissingFlag(m_missableObjectFlags[0x25], FlagType.FieldItem, "", "ROUTE_24_ITEM");
            CheckMissingFlag(m_missableObjectFlags[0x26], FlagType.FieldItem, "", "ROUTE_25_ITEM");
            CheckMissingFlag(m_missableObjectFlags[0x33], FlagType.FieldItem, "", "VIRIDIAN_GYM_ITEM");
            ...
            CheckMissingFlag(m_missableObjectFlags[0x39], FlagType.FieldItem, "", "POKEMON_TOWER_3F_ITEM");
            CheckMissingFlag(m_missableObjectFlags[0x3A], FlagType.FieldItem, "", "POKEMON_TOWER_4F_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0x3B], FlagType.FieldItem, "", "POKEMON_TOWER_4F_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0x3C], FlagType.FieldItem, "", "POKEMON_TOWER_4F_ITEM_3");
            CheckMissingFlag(m_missableObjectFlags[0x3D], FlagType.FieldItem, "", "POKEMON_TOWER_5F_ITEM");
            CheckMissingFlag(m_missableObjectFlags[0x3E], FlagType.FieldItem, "", "POKEMON_TOWER_6F_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0x3F], FlagType.FieldItem, "", "POKEMON_TOWER_6F_ITEM_2");
            ...
            CheckMissingFlag(m_missableObjectFlags[0x6F], FlagType.FieldItem, "", "MT_MOON_B2F_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0x70], FlagType.FieldItem, "", "MT_MOON_B2F_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0x72], FlagType.FieldItem, "", "SS_ANNE_1F_ROOMS_ITEM");
            CheckMissingFlag(m_missableObjectFlags[0x73], FlagType.FieldItem, "", "SS_ANNE_2F_ROOMS_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0x74], FlagType.FieldItem, "", "SS_ANNE_2F_ROOMS_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0x75], FlagType.FieldItem, "", "SS_ANNE_B1F_ROOMS_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0x76], FlagType.FieldItem, "", "SS_ANNE_B1F_ROOMS_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0x77], FlagType.FieldItem, "", "SS_ANNE_B1F_ROOMS_ITEM_3");
            CheckMissingFlag(m_missableObjectFlags[0x78], FlagType.FieldItem, "", "VICTORY_ROAD_3F_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0x79], FlagType.FieldItem, "", "VICTORY_ROAD_3F_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0x7B], FlagType.FieldItem, "", "ROCKET_HIDEOUT_B1F_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0x7C], FlagType.FieldItem, "", "ROCKET_HIDEOUT_B1F_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0x7D], FlagType.FieldItem, "", "ROCKET_HIDEOUT_B2F_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0x7E], FlagType.FieldItem, "", "ROCKET_HIDEOUT_B2F_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0x7F], FlagType.FieldItem, "", "ROCKET_HIDEOUT_B2F_ITEM_3");
            CheckMissingFlag(m_missableObjectFlags[0x80], FlagType.FieldItem, "", "ROCKET_HIDEOUT_B2F_ITEM_4");
            CheckMissingFlag(m_missableObjectFlags[0x81], FlagType.FieldItem, "", "ROCKET_HIDEOUT_B3F_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0x82], FlagType.FieldItem, "", "ROCKET_HIDEOUT_B3F_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0x84], FlagType.FieldItem, "", "ROCKET_HIDEOUT_B4F_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0x85], FlagType.FieldItem, "", "ROCKET_HIDEOUT_B4F_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0x86], FlagType.FieldItem, "", "ROCKET_HIDEOUT_B4F_ITEM_3");
            CheckMissingFlag(m_missableObjectFlags[0x87], FlagType.FieldItem, "", "ROCKET_HIDEOUT_B4F_ITEM_4");
            CheckMissingFlag(m_missableObjectFlags[0x88], FlagType.FieldItem, "", "ROCKET_HIDEOUT_B4F_ITEM_5");
            CheckMissingFlag(m_missableObjectFlags[0x90], FlagType.FieldItem, "", "SILPH_CO_3F_ITEM");
            CheckMissingFlag(m_missableObjectFlags[0x94], FlagType.FieldItem, "", "SILPH_CO_4F_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0x95], FlagType.FieldItem, "", "SILPH_CO_4F_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0x96], FlagType.FieldItem, "", "SILPH_CO_4F_ITEM_3");
            CheckMissingFlag(m_missableObjectFlags[0x9B], FlagType.FieldItem, "", "SILPH_CO_5F_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0x9C], FlagType.FieldItem, "", "SILPH_CO_5F_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0x9D], FlagType.FieldItem, "", "SILPH_CO_5F_ITEM_3");
            CheckMissingFlag(m_missableObjectFlags[0xA1], FlagType.FieldItem, "", "SILPH_CO_6F_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0xA2], FlagType.FieldItem, "", "SILPH_CO_6F_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0xA8], FlagType.FieldItem, "", "SILPH_CO_7F_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0xA9], FlagType.FieldItem, "", "SILPH_CO_7F_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0xB4], FlagType.FieldItem, "", "SILPH_CO_10F_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0xB5], FlagType.FieldItem, "", "SILPH_CO_10F_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0xB6], FlagType.FieldItem, "", "SILPH_CO_10F_ITEM_3");
            CheckMissingFlag(m_missableObjectFlags[0xBB], FlagType.FieldItem, "", "POKEMON_MANSION_2F_ITEM");
            CheckMissingFlag(m_missableObjectFlags[0xBC], FlagType.FieldItem, "", "POKEMON_MANSION_3F_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0xBD], FlagType.FieldItem, "", "POKEMON_MANSION_3F_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0xBE], FlagType.FieldItem, "", "POKEMON_MANSION_B1F_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0xBF], FlagType.FieldItem, "", "POKEMON_MANSION_B1F_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0xC0], FlagType.FieldItem, "", "POKEMON_MANSION_B1F_ITEM_3");
            CheckMissingFlag(m_missableObjectFlags[0xC1], FlagType.FieldItem, "", "POKEMON_MANSION_B1F_ITEM_4");
            CheckMissingFlag(m_missableObjectFlags[0xC2], FlagType.FieldItem, "", "POKEMON_MANSION_B1F_ITEM_5");
            CheckMissingFlag(m_missableObjectFlags[0xC3], FlagType.FieldItem, "", "SAFARI_ZONE_EAST_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0xC4], FlagType.FieldItem, "", "SAFARI_ZONE_EAST_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0xC5], FlagType.FieldItem, "", "SAFARI_ZONE_EAST_ITEM_3");
            CheckMissingFlag(m_missableObjectFlags[0xC6], FlagType.FieldItem, "", "SAFARI_ZONE_EAST_ITEM_4");
            CheckMissingFlag(m_missableObjectFlags[0xC7], FlagType.FieldItem, "", "SAFARI_ZONE_NORTH_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0xC8], FlagType.FieldItem, "", "SAFARI_ZONE_NORTH_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0xC9], FlagType.FieldItem, "", "SAFARI_ZONE_WEST_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0xCA], FlagType.FieldItem, "", "SAFARI_ZONE_WEST_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0xCB], FlagType.FieldItem, "", "SAFARI_ZONE_WEST_ITEM_3");
            CheckMissingFlag(m_missableObjectFlags[0xCC], FlagType.FieldItem, "", "SAFARI_ZONE_WEST_ITEM_4");
            CheckMissingFlag(m_missableObjectFlags[0xCD], FlagType.FieldItem, "", "SAFARI_ZONE_CENTER_ITEM");
            CheckMissingFlag(m_missableObjectFlags[0xCE], FlagType.FieldItem, "", "CERULEAN_CAVE_2F_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0xCF], FlagType.FieldItem, "", "CERULEAN_CAVE_2F_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0xD0], FlagType.FieldItem, "", "CERULEAN_CAVE_2F_ITEM_3");
            CheckMissingFlag(m_missableObjectFlags[0xD2], FlagType.FieldItem, "", "CERULEAN_CAVE_B1F_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0xD3], FlagType.FieldItem, "", "CERULEAN_CAVE_B1F_ITEM_2");
            CheckMissingFlag(m_missableObjectFlags[0xD4], FlagType.FieldItem, "", "VICTORY_ROAD_1F_ITEM_1");
            CheckMissingFlag(m_missableObjectFlags[0xD5], FlagType.FieldItem, "", "VICTORY_ROAD_1F_ITEM_2");

            // In Game Trades
            CheckMissingFlag(m_completedInGameTradeFlags[0x00], FlagType.InGameTrade, "", "TRADE_FOR_TERRY");
            CheckMissingFlag(m_completedInGameTradeFlags[0x01], FlagType.InGameTrade, "", "TRADE_FOR_MARCEL");
            //CheckMissingFlag(m_completedInGameTradeFlags[0x02], FlagType.InGameTrade, "", "TRADE_FOR_CHIKUCHIKU"); // unused
            CheckMissingFlag(m_completedInGameTradeFlags[0x03], FlagType.InGameTrade, "", "TRADE_FOR_SAILOR");
            CheckMissingFlag(m_completedInGameTradeFlags[0x04], FlagType.InGameTrade, "", "TRADE_FOR_DUX");
            CheckMissingFlag(m_completedInGameTradeFlags[0x05], FlagType.InGameTrade, "", "TRADE_FOR_MARC");
            CheckMissingFlag(m_completedInGameTradeFlags[0x06], FlagType.InGameTrade, "", "TRADE_FOR_LOLA");
            CheckMissingFlag(m_completedInGameTradeFlags[0x07], FlagType.InGameTrade, "", "TRADE_FOR_DORIS");
            CheckMissingFlag(m_completedInGameTradeFlags[0x08], FlagType.InGameTrade, "", "TRADE_FOR_CRINKLES");
            CheckMissingFlag(m_completedInGameTradeFlags[0x09], FlagType.InGameTrade, "", "TRADE_FOR_SPOT");
            ...
            if (!m_eventFlags[0x57E] && !m_eventFlags[0x57F])
            {
                ...
                CheckMissingFlag(m_eventFlags[0x57E], FlagType.GeneralEvent, "", "GOT_DOME/HELIX_FOSSIL");
            }
